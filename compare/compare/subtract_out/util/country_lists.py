...
countries_annex1 = ['AUS', 'AUT', 'BLR', 'BEL', 'BGR', 'CAN', 'HRV', 'CYP', 'CZE', 'DNK', 'EST', 'FIN',
                    'FRA', 'DEU', 'GRC', 'HUN', 'ISL', 'IRL', 'ITA', 'JPN', 'KAZ', 'LVA', 'LIE', 'LTU', 'LUX',
                    'MLT', 'MCO', 'NLD', 'NZL', 'NOR', 'POL', 'PRT', 'ROU', 'RUS', 'SVK', 'SVN', 'ESP', 'SWE', 'CHE',
                    'TUR', 'UKR', 'GBR', 'USA']
countries_nonannex1 = ['ABW', 'AFG', 'ALB', 'DZA', 'AGO', 'ATG', 'ARG', 'ARM', 'AZE', 'BHS', 'BHR', 'BGD', 'BRA', 'BRB', 'BLZ', 'BEN',
                       'BTN', 'BOL', 'BIH', 'BWA', 'BRN', 'BFA', 'BDI', 'CPV', 'KHM', 'CMR', 'CAF', 'CHL', 'CHN', 'COL', 'COM',
                       'COG', 'CRI', 'CIV', 'CUB', 'PRK', 'COD', 'DJI', 'DMA', 'DOM', 'ECU', 'EGY', 'SLV', 'ERI', 'SWZ', 'HKG',
                       'ETH', 'FJI', 'GAB', 'GMB', 'GEO', 'GHA', 'GRD', 'GTM', 'GIN', 'GNB', 'GUY', 'HTI', 'HND', 'IDN',
                       'IND', 'IRN', 'IRQ', 'ISR', 'JAM', 'JOR', 'KEN', 'KIR', 'KWT', 'KGZ', 'LAO', 'LBN', 'LSO', 'LBR', 'MDG',
                       'MWI', 'MYS', 'MDV', 'MLI', 'MHL', 'MRT', 'MUS', 'MEX', 'FSM', 'MNG', 'MNE', 'MAR', 'MOZ', 'MMR',
                       'NAM', 'NRU', 'NPL', 'NIC', 'NER', 'NGA', 'NIU', 'MKD', 'OMN', 'PLW', 'PAN', 'PRY', 'PER', 'PHL',
                       'QAT', 'KOR', 'MDA', 'RWA', 'KNA', 'LCA', 'VCT', 'WSM', 'SMR', 'STP', 'SAU', 'SEN', 'SRB', 'SYC',
                       'SGP', 'SLB', 'ZAF', 'SSD', 'LKA', 'PSE', 'SDN', 'TJK', 'THA', 'TLS', 'TGO', 'TON', 'TTO', 'TUN',
                       'TKM', 'TUV', 'UGA', 'ARE', 'TZA', 'URY', 'UZB', 'VUT', 'VEN', 'YEM', 'ZMB', 'ZWE', 'TCD', 'COK', 'PAK',
                       'PNG', 'SUR', 'VNM', 'TWN']
