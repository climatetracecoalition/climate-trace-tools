...
TITLE_CONVERSION = pd.read_csv('files/CT_country_titles.csv').applymap(lambda x: x.strip(' '))
...
def get_country_title(iso3):
    ...
    return TITLE_CONVERSION.loc[TITLE_CONVERSION['iso3'] == iso3, 'country_title'].values[0]
