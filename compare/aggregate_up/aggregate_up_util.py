...
def read_zip(inventory, iso3_country):
...
def sector_color_map():
    color_dict = {'Energy Industries and Fugitive Emissions': 'darkgreen',
...
def get_tick_label_dict():
    tick_label_dict = {'climate-trace': 'Climate TRACE',
...
def plotly_formatting():
    ...
    layout = {'paper_bgcolor': 'rgba(255, 255, 255)',
